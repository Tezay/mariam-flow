...
export const en = {
  ...
  'cal.lead':
    'Record what the queue looks like, so a model can be trained for this site. The recording is exported and trained elsewhere; the model comes back afterwards.',
  'cal.classes': 'What the levels mean here',
  'cal.classesLead':
  ...
  'cal.positionsHint': 'Optional, and reused from the last recording.',
